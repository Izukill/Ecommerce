...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    static enum ErrorType {
        ERRO_INESPERADO, REQUISICAO_INVALIDA, REGRA_NEGOCIO, ERRO_DE_VALIDACAO, ENTIDADE_NAO_ENCONTRADA;
    }
    ...
    public ProblemDetail handleEduConnectException(RegraNegocioException ex) {
        return buildProblemDetail(ex, HttpStatus.BAD_REQUEST, ErrorType.REGRA_NEGOCIO);
    }
