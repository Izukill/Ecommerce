...
public interface AdministradorRestControllerAPI {
    ...
    ResponseEntity<Page<AdministradorResponseDTO>> buscar(@ParameterObject AdministradorBuscarDTO dto, @ParameterObject Pageable pageable) throws MirlleException;
